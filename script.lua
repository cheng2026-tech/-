...
local Ti=Instance.new("TextLabel",LG);Ti.Size=UDim2.new(1,0,0,70);Ti.Position=UDim2.new(0,0,0.3,0);Ti.BackgroundTransparency=1;Ti.Text="程 程 大 王";Ti.TextColor3=Color3.fromRGB(80,220,80);Ti.TextSize=50;Ti.Font=Enum.Font.GothamBold
local Su=Instance.new("TextLabel",LG);Su.Size=UDim2.new(1,0,0,26);Su.Position=UDim2.new(0,0,0.3,72);Su.BackgroundTransparency=1;Su.Text="SYSTEM DECRYPTION";Su.TextColor3=Color3.fromRGB(80,220,80);Su.TextSize=20;Su.Font=Enum.Font.Gotham
...
local PL2=Instance.new("TextLabel",LG);PL2.Size=UDim2.new(1,0,0,40);PL2.Position=UDim2.new(0,0,0.55,25);PL2.BackgroundTransparency=1;PL2.Text="0%";PL2.TextColor3=Color3.fromRGB(80,220,80);PL2.TextSize=30;PL2.Font=Enum.Font.Gotham
local SkipBtn=Instance.new("TextButton",LG);SkipBtn.Size=UDim2.new(0,70,0,24);SkipBtn.Position=UDim2.new(1,-80,1,-40);SkipBtn.BackgroundColor3=Color3.fromRGB(20,20,20);SkipBtn.Text="[ 跳过 ]";SkipBtn.TextColor3=Color3.fromRGB(80,220,80);SkipBtn.TextSize=14;SkipBtn.Font=Enum.Font.Gotham;SkipBtn.BorderSizePixel=0
...
local FBt=Instance.new("TextButton",SG);FBt.Size=UDim2.new(0,40,0,40);FBt.Position=UDim2.new(0,10,0.5,-20);FBt.BackgroundColor3=Color3.fromRGB(20,20,28);FBt.Text="⚙";FBt.TextColor3=Color3.fromRGB(120,80,255);FBt.TextSize=24;FBt.Font=Enum.Font.GothamBold;FBt.BorderSizePixel=0
Instance.new("UICorner",FBt).CornerRadius=UDim.new(1,0)
local MF=Instance.new("Frame",SG);MF.Size=UDim2.new(0,220,0,280);MF.Position=UDim2.new(0.5,-110,0.5,-140);MF.BackgroundColor3=Color3.fromRGB(15,15,20);MF.BorderSizePixel=0;MF.Active=true;MF.Draggable=true
Instance.new("UICorner",MF).CornerRadius=UDim.new(0,10)
local MSt=Instance.new("UIStroke",MF);MSt.Color=Color3.fromRGB(100,200,255);MSt.Thickness=1.5;MSt.Transparency=0.4
local XB=Instance.new("TextButton",MF);XB.Size=UDim2.new(0,20,0,20);XB.Position=UDim2.new(1,-25,0,5);XB.BackgroundColor3=Color3.fromRGB(200,50,60);XB.Text="×";XB.TextColor3=Color3.fromRGB(255,255,255);XB.TextSize=16;XB.Font=Enum.Font.GothamBold;XB.BorderSizePixel=0
Instance.new("UICorner",XB).CornerRadius=UDim.new(1,0)
local FB=Instance.new("TextButton",MF);FB.Size=UDim2.new(0.9,0,0,30);FB.Position=UDim2.new(0.05,0,0,30);FB.BackgroundColor3=Color3.fromRGB(35,35,48);FB.Text="飞行:关";FB.TextColor3=Color3.fromRGB(200,200,200);FB.TextSize=14;FB.Font=Enum.Font.Gotham;FB.BorderSizePixel=0
Instance.new("UICorner",FB).CornerRadius=UDim.new(0,6)
local FSL=Instance.new("TextLabel",MF);FSL.Size=UDim2.new(0.9,0,0,15);FSL.Position=UDim2.new(0.05,0,0,65);FSL.BackgroundTransparency=1;FSL.Text="飞行速度: 100";FSL.TextColor3=Color3.fromRGB(200,200,200);FSL.TextSize=12;FSL.Font=Enum.Font.Gotham
...
local WL=Instance.new("TextLabel",MF);WL.Size=UDim2.new(0.9,0,0,15);WL.Position=UDim2.new(0.05,0,0,95);WL.BackgroundTransparency=1;WL.Text="跑步速度: 16";WL.TextColor3=Color3.fromRGB(200,200,200);WL.TextSize=12;WL.Font=Enum.Font.Gotham
...
local JB=Instance.new("TextButton",MF);JB.Size=UDim2.new(0.9,0,0,30);JB.Position=UDim2.new(0.05,0,0,130);JB.BackgroundColor3=Color3.fromRGB(35,35,48);JB.Text="无限跳:关";JB.TextColor3=Color3.fromRGB(200,200,200);JB.TextSize=14;JB.Font=Enum.Font.Gotham;JB.BorderSizePixel=0
