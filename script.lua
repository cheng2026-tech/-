...
-- 监控标签页
local TM=Instance.new("Frame",CB);TM.Size=UDim2.new(1,0,1,0);TM.BackgroundTransparency=1;TM.Visible=false;TFs["监控"]=TM
...
local OptB=Instance.new("TextButton",TM);OptB.Size=UDim2.new(0.9,0,0,28);OptB.Position=UDim2.new(0.05,0,0,120);OptB.BackgroundColor3=Color3.fromRGB(60,120,60);OptB.Text="⚡ 一键优化+清理";OptB.TextColor3=Color3.fromRGB(255,255,255);OptB.TextSize=11;OptB.Font=Enum.Font.GothamBold;OptB.BorderSizePixel=0
Instance.new("UICorner",OptB).CornerRadius=UDim.new(0,8)
local UndB=Instance.new("TextButton",TM);UndB.Size=UDim2.new(0.9,0,0,24);UndB.Position=UDim2.new(0.05,0,0,155);UndB.BackgroundColor3=Color3.fromRGB(40,40,55);UndB.Text="♻️ 恢复对象";UndB.TextColor3=Color3.fromRGB(200,200,220);UndB.TextSize=11;UndB.Font=Enum.Font.Gotham;UndB.BorderSizePixel=0
...
local ScB=Instance.new("TextButton",TA);ScB.Size=UDim2.new(0.45,0,0,26);ScB.Position=UDim2.new(0.03,0,0,10);ScB.BackgroundColor3=Color3.fromRGB(60,30,100);ScB.Text="🔍 扫描管理员";ScB.TextColor3=Color3.fromRGB(220,180,255);ScB.TextSize=11;ScB.Font=Enum.Font.Gotham;ScB.BorderSizePixel=0
Instance.new("UICorner",ScB).CornerRadius=UDim.new(0,8)
local ClB=Instance.new("TextButton",TA);ClB.Size=UDim2.new(0.45,0,0,26);ClB.Position=UDim2.new(0.52,0,0,10);ClB.BackgroundColor3=Color3.fromRGB(40,40,55);ClB.Text="清空日志";ClB.TextColor3=Color3.fromRGB(200,200,200);ClB.TextSize=11;ClB.Font=Enum.Font.Gotham;ClB.BorderSizePixel=0
Instance.new("UICorner",ClB).CornerRadius=UDim.new(0,8)
local LG2=Instance.new("ScrollingFrame",TA);LG2.Size=UDim2.new(0.94,0,1,-50);LG2.Position=UDim2.new(0.03,0,0,44);LG2.BackgroundColor3=Color3.fromRGB(12,12,18);LG2.BorderSizePixel=0;LG2.ScrollBarThickness=3;LG2.CanvasSize=UDim2.new(0,0,0,0)
...
local ClkB=Instance.new("TextButton",TV);ClkB.Size=UDim2.new(0.9,0,0,32);ClkB.Position=UDim2.new(0.05,0,0,10);ClkB.BackgroundColor3=Color3.fromRGB(180,60,30);ClkB.Text="🎯 点击删除:关";ClkB.TextColor3=Color3.fromRGB(255,255,255);ClkB.TextSize=12;ClkB.Font=Enum.Font.Gotham;ClkB.BorderSizePixel=0
Instance.new("UICorner",ClkB).CornerRadius=UDim.new(0,8)
local RsB=Instance.new("TextButton",TV);RsB.Size=UDim2.new(0.9,0,0,32);RsB.Position=UDim2.new(0.05,0,0,52);RsB.BackgroundColor3=Color3.fromRGB(40,40,55);RsB.Text="♻️ 恢复全部";RsB.TextColor3=Color3.fromRGB(200,200,200);RsB.TextSize=12;RsB.Font=Enum.Font.Gotham;RsB.BorderSizePixel=0
Instance.new("UICorner",RsB).CornerRadius=UDim.new(0,8)

-- 标签页按钮创建
for i,name in ipairs(Tabs) do
    local btn=Instance.new("TextButton",SB);btn.Size=UDim2.new(0.9,0,0,32);btn.Position=UDim2.new(0.05,0,0,8+(i-1)*40);btn.BackgroundColor3=Color3.fromRGB(25,25,35);btn.Text=name;btn.TextColor3=Color3.fromRGB(180,180,200);btn.TextSize=12;btn.Font=Enum.Font.Gotham;btn.BorderSizePixel=0
...
local YesB=Instance.new("TextButton",CF);YesB.Size=UDim2.new(0,100,0,32);YesB.Position=UDim2.new(0,15,0,70);YesB.BackgroundColor3=Color3.fromRGB(200,50,60);YesB.Text="确定关闭";YesB.TextColor3=Color3.fromRGB(255,255,255);YesB.TextSize=12;YesB.Font=Enum.Font.GothamBold;YesB.ZIndex=502;YesB.BorderSizePixel=0
Instance.new("UICorner",YesB).CornerRadius=UDim.new(0,8)
local NoB=Instance.new("TextButton",CF);NoB.Size=UDim2.new(0,100,0,32);NoB.Position=UDim2.new(1,-115,0,70);NoB.BackgroundColor3=Color3.fromRGB(40,40,55);NoB.Text="取消";NoB.TextColor3=Color3.fromRGB(200,200,200);NoB.TextSize=12;NoB.Font=Enum.Font.GothamBold;NoB.ZIndex=502;NoB.BorderSizePixel=0
